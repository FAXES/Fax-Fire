...
local chanceForSpread = 5 -- basically a thousand sided dice is rolled and if it gets above this number then the fire spreads once
...
local spawnRandomFireChance = 4 -- basically a thousand sided dice is rolled and if it gets above this number then a fire spawns at one of the locations specified
local randomSpawnTime = 1200000 -- time to wait before trying to spawn another random fire in milliseconds 1,200,000 is 20 minutes this is per player.
...
AddEventHandler("lol:firecounter", function()
		...
		TriggerEvent("chatMessage", "Coords", {255, 0, 0},"There has been " .. counter .. " fires so far.")
...
AddEventHandler("lol:carbomb", function()
    ...
    TriggerEvent("chatMessage", "FIRE Script", {255, 0, 0},"You made that car go BOOM!")
